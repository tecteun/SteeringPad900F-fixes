...
(note: this fork seems to be bugged, for example springeffect is broken, I'm currently looking for a way to test/debug all ffb effect types, it seems a better idea to use the official [ArduinoJoystickWithFFBLibrary](https://github.com/YukMingLaw/ArduinoJoystickWithFFBLibrary))
